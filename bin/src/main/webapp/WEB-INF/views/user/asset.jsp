									...
									<div class="form-group p-1">
										...
										<div class="container" style="width: inherit;">
											...
											<!-------------------------------Asset Req No.----------------------------------------------------------->
													...
													<div>
														<c:forEach var="splt" items="${assetslist}">
															<td><input type="checkbox" class="gender" value="${splt}"
																name="asset_request" style="width: 100px;" />${splt}<br>
															</td>
												...
												<div id="menu1" class="tab-pane fade">
													...
													<textarea style="color: black" id="remarks" name="remarks"
													 class="form-control">by ${email} on <%=new java.sql.Date( new java.util.Date().getTime() ).toLocalDate()%></textarea>
