...
<table class="table" style="width: 100%" id="grid">
				...
				<c:forEach items="${result}" var="asset" varStatus="status">
					<tr>
						...
						<td><a href = "<c:url value = "/user/trackinfo?asset_id=${asset.getAsset_id()}"/>" onMouseOver="this.style.color='black'"
        onMouseOut="this.style.color='blue'"><c:out value="${asset.getUnique_id()}"/></a></td>
